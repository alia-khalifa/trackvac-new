...
export default class HomeTwo extends Component {
    ...
    componentDidMount = async () => {
        ...
        await api.initHome().then(homeArr => {
            this.setState({
                homeInfo: homeArr.data,
            })
        }).catch(e => {
                ...
                <div>
                    <header id="header">
                        ...
                        <div id="popUp">
                            ...
                            <h2>
                                <img src="images/logo-ieee-hac.png" alt width="90px" height="55px" />
                            </h2>
                            <p style={{ fontSize: 10, marginBottom: 0, lineHeight: 15 }}>The IEEE HAC provides a suite of resources that
                                inspire and enable IEEE volunteers around the world to carry out and support impactful humanitarian technology
                                and sustainable development activities at the local level.</p>
                            <br />
                                ...
                                <li className="first">
                                    <div className="slider-text-wrapper">
                                        <div className="container">
                                            ...
                                            <a href="/reviews" className="middle btn btn-white" id="sliderbtn">WRITE REVIEW</a>
                                        </div>
                                    </div>
                                ...
                                <li className="secondary">
                                    <div className="slider-text-wrapper">
                                        <div className="container">
                                            ...
                                            <a href="/reviews" className=" middle btn btn-white" id="sliderbtn">READ REVIEWS</a>
                                        </div>
                                    </div>
                                ...
                                <li className="first">
                                    <div className="slider-text-wrapper">
                                        <div className="container">
                                            ...
                                            <a href="/questions" className="middle btn btn-white" id="sliderbtn">ASK OTHERS</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-12">
                                        <div className="tabs tabs-main">
                                            <ul className="nav nav-tabs">
                                                ...
                                                <li><a href="#three" data-toggle="tab">Top Service</a></li>
                                            </ul>
                                                        ...
                                                        <div className="container">
                                                            <div className="row">
                                                                <div className="col-md-10" style={{ marginLeft: '2.5rem' }}>
                                                                    {/*  */}
                                                                    <Carousel>
                                                                        {this.state.homeInfo ? (this.state.homeInfo).map((tp) => (
                                                                            <Carousel.Item>
                                                                                <div className="items">
                                                                                    <div className="title-box text-center white">
                                                                                        <h2 className="title" style={{ color: '#D3E0EA' }}>
                                                                                            {tp.cityName}
                                                                                        </h2>
                                                                                    </div>
                                                                                    <div className="card mb-3">
                                                                                        <div id="map-container-google-12" className="z-depth-1-half map-container-7" style={{ height: 200 }}>
                                                                                            <iframe src={tp.topClean.location} frameBorder={0} style={{ border: 0 }} allowFullScreen />
                                                                                        </div>
                                                                                        <div className="card-body">
                                                                                            <h5 className="card-title" style={{ fontWeight: 800, fontSize: 'x-large', color: '#1687A7' }}>
                                                                                                {tp.topClean.placeName}
                                                                                            </h5>
                                                                                            <p className="card-text" style={{ fontSize: 25, color: 'goldenrod' }}>
                                                                                                <Rating name="read-only" value={tp.topClean.cleanRate ? tp.topClean.cleanRate : 0} readOnly />
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            {this.state.homeInfo ? (this.state.homeInfo).map((tp) => (
                                                                                <Carousel.Item>
                                                                                    <div className="items">
                                                                                        ...
                                                                                        <div className="card mb-3">
                                                                                            <div id="map-container-google-12" className="z-depth-1-half map-container-7" style={{ height: 200 }}>
                                                                                                <iframe src={tp.topSpeed.location} frameBorder={0} style={{ border: 0 }} allowFullScreen />
                                                                                            </div>
                                                                                            <div className="card-body">
                                                                                                <h5 className="card-title" style={{ fontWeight: 800, fontSize: 'x-large', color: '#1687A7' }}>
                                                                                                    {tp.topSpeed.placeName}
                                                                                                </h5>
                                                                                                <p className="card-text" style={{ fontSize: 25, color: 'goldenrod' }}>
                                                                                                    <Rating name="read-only" value={tp.topSpeed.speedRate ? tp.topSpeed.speedRate : 0} readOnly />
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            {this.state.homeInfo ? (this.state.homeInfo).map((tp) => (
                                                                                <Carousel.Item>
                                                                                    <div className="items">
                                                                                        ...
                                                                                        <div className="card mb-3">
                                                                                            <div id="map-container-google-12" className="z-depth-1-half map-container-7" style={{ height: 200 }}>
                                                                                                <iframe src={tp.topService.location} frameBorder={0} style={{ border: 0 }} allowFullScreen />
                                                                                            </div>
                                                                                            <div className="card-body">
                                                                                                <h5 className="card-title" style={{ fontWeight: 800, fontSize: 'x-large', color: '#1687A7' }}>
                                                                                                    {tp.topService.placeName}
                                                                                                </h5>
                                                                                                <p className="card-text" style={{ fontSize: 25, color: 'goldenrod' }}>
                                                                                                    <Rating name="read-only" value={tp.topService.serviceRate ? tp.topService.serviceRate : 0} readOnly />
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                            ...
                            <div className="col-md-4">
                                <div className="services-box" style={{ border: '3px solid #4792a7' }}>
                                    ...
                                    <div className="services-desc">
                                        ...
                                        <p style={{ color: '#D3E0EA', fontWeight: 500 }}>Facilitating the process of vaccination by providing necessary
                                            information about how to recieve the vaccine locally. </p>
                                    </div>
                                </div>
                            </div>
                            {/*End services Item*/}
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="copyright">
                                <p style={{ marginBottom: 0, lineHeight: 15 }}>© 2021 TrackVac
                                    {/*start social icons*/}
